...
const  NewsLetter=()=> {
  return (
    <div className='max-w-[1520px] m-auto text-white px-4 bg-[#24262b] mt-14'>
        <div className='mx-auto grid lg:grid-cols-3'>
            ...
            <div className='my-4'>
                <div className='flex flex-col sm:flex-row items-center justify-between w-full'>
                    ...
                    />
                    <button className='bg-[#00df9a] text-white rounded-md font-medium w-[200p] my-6 px-6 border-none ml-4 '>
                       Notify Me
                    </button>
